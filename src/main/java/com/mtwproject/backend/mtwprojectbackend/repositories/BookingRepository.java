...
public interface BookingRepository  extends CrudRepository <Booking, Long>{
    ...
    @Query("SELECT b FROM Booking b WHERE (:idBooking IS NULL OR b.idBooking = :idBooking) " +
       "AND (:applicant IS NULL OR b.applicant = :applicant) " +
...
List<Booking> listBookingsByParams(Long idBooking, String applicant, Long idCompany, Long idPassenger, Long idDriver);
